import { IncidentEntity, NoticeAudience, ReceiptStatus, ReservationStatus, User, UserRole } from '@/lib/types';
...
export function labelReceiptStatus(status: ReceiptStatus): string {
  switch (status) {
    case 'PENDING':
      return 'Pendiente';
    case 'PAID':
