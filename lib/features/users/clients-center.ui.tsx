      ...
      <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2">
              ...
              {isSuspended ? (
                ...
                <span className="inline-flex items-center rounded-md bg-emerald-100 px-2 py-0.5 text-[10px] font-black text-emerald-700">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            disabled={isPending}
            className={`flex flex-1 items-center justify-center gap-2 rounded-xl px-4 py-2 text-xs font-bold transition-colors disabled:opacity-50 ${
              isSuspended
